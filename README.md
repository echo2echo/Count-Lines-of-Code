...
Until --omit flag is fixed you will need at least 2 files in the directory you ar using the script.  Or create a small perl file for the script to run without errors
